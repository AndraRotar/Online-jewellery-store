...
const category = document.querySelector(".body-jewelley-container");
...
fetch("https://632b4e9d1090510116d684a1.mockapi.io/Products")
  ...
  .then((data) => {
    let output = "";
    data.map((product) => {
      if (product.category == "Body jewellery") {
        output += `<div class='card-body-jewellery'>
        <h3>${product.name}</h3>
...
document
  .querySelector(".body-jewelley-container")
